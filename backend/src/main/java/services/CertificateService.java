...
public class CertificateService {
  ...
  @Inject CertificateMapper certificateMapper;
  ...
  public CertificateDto updateCertificateDto(Long id, CertificateDto certificateDto) {
    ...
    updateIfNotNull(
        certificateDto.getCertificateType(), existingCertificateEntity::setCertificateType);
    ...
    if (certificateDto.getComments() != null) {
      Map<Long, CommentEntity> existingComments =
          existingCertificateEntity.getComments().stream()
  ...
  public void removeAssignedUser(Long certificateId, Long userId) {
    ...
    if (certificate.getAssignedUsers().remove(user)) {
      ...
      throw new NotFoundException(
          "User with id " + userId + " is not assigned to certificate with id " + certificateId);
    }
  }
}
